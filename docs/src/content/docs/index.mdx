...
# starlight-page-actions derives the Markdown URL as pathname-minus-trailing-slash
# + '.md', which on the site root resolves to `/starlight-quiz.md` — one level above
# the deployed base, so it 404s and cannot be served from here. The page's Markdown
# is still reachable at index.md, via rel="alternate" and via llms.txt.
pageActions: false
---
...
- 🌐 **Internationalisation** — 14 languages out of the box, shared with mkdocs-quiz.
