...
Both the message and the button label are translatable (English, French, German and Spanish out of the box) and can be
overridden per-instance — handy in a vanilla Astro project:

```astro
<QuizIntro textLabel="Your answers are saved locally." resetLabel="Start over" />
```

See [Configuration](/starlight-quiz/guides/configuration/) for the full list of component props.
