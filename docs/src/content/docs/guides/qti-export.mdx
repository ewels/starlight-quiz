...
Point `export-qti` at your deployed site (or a local build directory), and choose an output directory:

```sh
# QTI 2.1 (the default)
npx starlight-quiz export-qti https://ewels.github.io/starlight-quiz --out ./qti
```
...
```sh
npx starlight-quiz export-qti https://ewels.github.io/starlight-quiz --version 1.2 --out ./qti
```
:::
