...
[task list](https://github.github.com/gfm/#task-list-items-extension-) of answers, and an optional content section:
...
A ticked box (`[x]`) is a correct answer; an empty box (`[ ]`) is incorrect. This renders as:

<Quiz title="Static site generators" id="quickstart-basic">
Question text goes here.
...
<Quiz title="Programming languages" id="quickstart-multiple">
...
<Quiz title="Capital city" id="quickstart-blank">
