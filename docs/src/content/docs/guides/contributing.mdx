...
Translations are gettext `.po` files in `packages/starlight-quiz/locales/`, whose shared strings match
[mkdocs-quiz](https://github.com/ewels/mkdocs-quiz)'s so both plugins stay in sync. See
